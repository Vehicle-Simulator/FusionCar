...
namespace Example
{
    ...
    public abstract class Player : NetworkKCCProcessor
    {
        ...
        [Networked] public float SpeedMultiplier { get; set; } = 1.0f;

        // PROTECTED MEMBERS

        protected CinemachineVirtualCamera Camera => _camera;
        ...
        [SerializeField] private float _areaOfInterestRadius;
        [SerializeField] private Vector3 _jumpImpulse;
        [SerializeField] private DashKCCProcessor _dashProcessor;
        ...
        public void SetParentedMode(bool parented, Vector3 position, Quaternion rotation)
        {
            KCC.SetParent(parented, position, rotation);
        }
