...
namespace Fusion.Assistants
{
    public static class FusionSceneSetupAssistants
    {
        ...
        public static void SetupBasicFusionScene()
        {
            ...
            var floor = FusionAssistants.CreatePrimitive(PrimitiveType.Cube, "Prototype Floor", new Vector3(0, -1, 0),
                null, new Vector3(20, 2, 20), null, FusionPrototypeMaterials.Floor).transform;

            // Delete any existing spawn points
            var found = Object.FindObjectsOfType<PlayerSpawnPointPrototype>();
            ...
            // Add 5 spawn points
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 0", new Vector3(-2, 2, 4),
                Quaternion.Euler(0, 160, 0), null, floor, null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 1", new Vector3(2, 2, 4),
                Quaternion.Euler(0, 200, 0), null, floor, null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 2", new Vector3(4, 2, 0),
                Quaternion.Euler(0, -90, 0), null, floor, null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 3", new Vector3(0, 2, -4),
                Quaternion.Euler(0, 0, 0), null, floor, null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 4", new Vector3(-4, 2, 0),
                Quaternion.Euler(0, 90, 0), null, floor, null, typeof(PlayerSpawnPointPrototype));
        ...
        public static void SetupBasic2DFusionScene()
        {
            ...
            // Add 5 spawn points
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 0", new Vector3(-4, 2, 0), default, null, floor,
                null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 1", new Vector3(-2, 2, 0), default, null, floor,
                null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 2", new Vector3(-0, 2, 0), default, null, floor,
                null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 3", new Vector3(2, 2, 0), default, null, floor,
                null, typeof(PlayerSpawnPointPrototype));
            FusionAssistants.CreatePrimitive(null, "Player SpawnPoint 4", new Vector3(4, 2, 0), default, null, floor,
                null, typeof(PlayerSpawnPointPrototype));
        ...
        public static (NetworkDebugStart, NetworkRunner) AddNetworkStartup()
        {
            ...
            NetworkRunner nr = nds.RunnerPrefab == null ? null :
                nds.RunnerPrefab.TryGetComponent<NetworkRunner>(out var found) ? found : null;
        ...
        public static void AddPlayerSpawner()
        {
            AddPlayerSpawner(null);
        }
        ...
        public static void AddPlayerSpawnPoint()
        {
            ...
            var point = FusionAssistants.CreatePrimitive(null, "Player SpawnPoint", null, null, null, parent, null,
                typeof(PlayerSpawnPointPrototype));
        ...
        public static void AddCurrentSceneToSettings()
        {
            DirtyAndSaveScene(SceneManager.GetActiveScene());
        }
        ...
        public static void HandleAudioListeners()
        {
            ...
            Debug.Log(
                $"{count} {nameof(AudioListener)}(s) found and given a {nameof(RunnerVisibilityNode)} component.");
        }
    }
}
